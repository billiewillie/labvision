...
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isSamePath, withLeadingSlash, encodePath, encodeParam } from "ufo";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/contacts-D8woWdkr.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
