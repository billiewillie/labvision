...
import { a as useRouter, n as nuxtLinkDefaults, b as useRuntimeConfig, c as navigateTo, d as cn, _ as _export_sfc } from "../server.mjs";
import { _ as __nuxt_component_1, b as __nuxt_component_4, a as _sfc_main$e } from "./contactForm-y-7LGMh2.js";
import { cva } from "class-variance-authority";
import __nuxt_component_5 from "./Icon-dyynnY3J.js";
...
import { useForwardPropsEmits, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, DialogClose, DialogTitle, DialogDescription, useForwardProps, VisuallyHidden } from "radix-vue";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed w-full top-0 left-0 flex justify-between items-center shadow-lg z-30 bg-background py-4 xl:py-4 px-4 xl:px-8" }, _attrs))} data-v-dbc586ef>`);
      ...
      _push(`<ul class="hidden 2xl:flex gap-8" data-v-dbc586ef><!--[-->`);
      ssrRenderList(unref(NAVIGATION$1), (item) => {
        _push(`<li data-v-dbc586ef>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            _push2(ssrRenderComponent(_component_SheetContent, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<ul class="grid gap-8 py-8 text-center" data-v-dbc586ef${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(NAVIGATION$1), (item) => {
                    _push3(`<li data-v-dbc586ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_DialogClose, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<a${ssrRenderAttr("href", item.href)} data-v-dbc586ef${_scopeId3}>${ssrInterpolate(item.title)}</a>`);
                        } else {
                          return [
                            createVNode("a", {
                              href: item.href
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-dbc586ef"]]);
const __nuxt_component_1_lazy = defineAsyncComponent(() => import("./footer-DVS7e-01.js").then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=default-BeT6bCnP.js.map
