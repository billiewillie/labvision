import { defineComponent, mergeProps, useSSRContext, watch, h, withCtx, createVNode } from "vue";
import "hookable";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
import { publicAssetsURL } from "#internal/nuxt/paths";
import { _ as __nuxt_component_1, a as _sfc_main$c } from "./contactForm-y-7LGMh2.js";
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="black container grid grid-cols-1 xl:grid-cols-2 gap-28 xl:gap-8 justify-between"><div class="text-wrap grid gap-12 relative xl:top-0 xl:left-0 xl:right-0 xl:bottom-0 w-full xl:h-[80vh]"><div class="panel-text xl:absolute xl:top-0 xl:left-0 xl:right-0 xl:bottom-0 xl:w-full xl:h-full xl:opacity-0 xl:translate-y-full z-10"><h2 class="~text-[40px]/[48px] leading-[1.1] xl:text-[48px] font-extralight mb-8"><span class="text-primary">Современное и надежное</span> конструктивное решение </h2><p class="text-[20px]">Конструкция прибора соответствует всем самым современным тенденциям и стандартам и ориентирована на максимальную гибкость в решении различных исследовательских и рутинных задач</p></div><div class="panel-text xl:absolute xl:top-0 xl:left-0 xl:right-0 xl:bottom-0 xl:w-full xl:h-full xl:opacity-0 xl:translate-y-full z-10"><h2 class="~text-[40px]/[48px] leading-[1.1] xl:text-[48px] font-extralight mb-8"> Доступные конфигурации проточного цитометра <span class="text-primary">CELLRIVER</span></h2><ul class="flex flex-col gap-4"><li class="flex gap-4 items-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="container"><h2 class="relative leading-[1] font-bold drop-shadow-xl opacity-80 uppercase ~text-[40px]/[50px] md:~text-[70px]/[80px] lg:~text-[80px]/[90px] xl:~text-[100px]/[140px] 2xl:~text-[140px]/[150px]"> Производится в России </h2></div></section>`);
}
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="container soft-black grid grid-cols-1 xl:grid-cols-2 gap-8"><h2 class="~text-[32px]/[50px] xl:col-span-2 font-extralight leading-[1.1]"> Программное обеспечение <span class="text-primary">FlowExpert</span></h2><div class="flex relative overflow-hidden top-0 h-[40vh] xl:h-[80vh] flex-col gap-8">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        format: "webp",
      ...
      _push(`</div><div class="soft-text-wrap relative flex flex-col gap-12 xl:top-0 left-0 right-0 bottom-0 w-full xl:h-[80vh] xl:pl-8"><div class="soft-panel-text xl:absolute xl:top-0 xl:left-0 xl:right-0 xl:bottom-0 w-full xl:h-full xl:opacity-0 xl:translate-y-full z-10 flex flex-col gap-4"><h2 class="~text-[28px]/[40px] leading-[1.1] font-extralight"> Возможность использования готовых протоколов сбора и анализа данных </h2><p>для рутинных лабораторных исследований иммунного статуса:</p><ul class="flex flex-col gap-4"><li class="flex gap-4 items-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        class: "object-contain",
        width: "42",
        height: "42",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_BaseContactForm = _sfc_main$c;
  _push(`<section${ssrRenderAttrs(mergeProps({
    id: "contacts",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_SectionFirstScreen = _sfc_main$b;
  const _component_SectionSecondScreen = _sfc_main$a;
  const _component_SectionThirdScreen = _sfc_main$9;
  const _component_SectionFourthScreen = _sfc_main$8;
  const _component_SectionMadeInRussiaScreen = __nuxt_component_4;
  const _component_SectionFifthScreen = _sfc_main$6;
  const _component_SectionAreasScreen = _sfc_main$5;
  const _component_SectionSoftScreen = _sfc_main$4;
  const _component_SectionServiceScreen = _sfc_main$3;
  const _component_NuxtMarquee = _sfc_main$2;
  const _component_SectionContactsScreen = __nuxt_component_10;
  ...
  _push(`<section class="bg-foreground">`);
  _push(ssrRenderComponent(_component_NuxtMarquee, { class: "py-16 gap-24" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="uppercase drop-shadow-[0_0_15px_rgba(0,0,0,0.7)] text-[70px] xl:text-[90px] font-black"${_scopeId}>Доступен для вашей лаборатории прямо сейчас</p>`);
      } else {
        return [
          createVNode("p", { class: "uppercase drop-shadow-[0_0_15px_rgba(0,0,0,0.7)] text-[70px] xl:text-[90px] font-black" }, "Доступен для вашей лаборатории прямо сейчас")
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=index-S-zVUa9X.js.map
