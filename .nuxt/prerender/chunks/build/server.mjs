...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-D8NPB6ZZ.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-2nc4jQ1L.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-eFMmkCXp.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-NytQWukr.mjs').then((m) => m.default || m)
};
