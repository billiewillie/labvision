import { version, unref, inject, defineAsyncComponent, toRef, isRef, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, mergeProps, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, isVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, Fragment, renderList, createApp, effectScope, reactive, getCurrentInstance, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/ofetch/dist/node.mjs';
...
import { appendHeader, sanitizeStatusCode, createError as createError$1 } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/vue-router/dist/vue-router.node.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, withLeadingSlash, encodeParam, encodePath, isSamePath } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/ufo/dist/index.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/defu/dist/defu.mjs';
import { gsap as gsap$2 } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/gsap/dist/gsap.js';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrInterpolate, ssrRenderVNode, ssrRenderSuspense } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/vue/server-renderer/index.mjs';
import { cva } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/class-variance-authority/dist/index.mjs';
import { useForwardPropsEmits, ToastRoot, ToastViewport, ToastClose, ToastTitle, ToastDescription, ToastProvider } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/radix-vue/dist/index.js';
import { clsx } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/clsx/dist/clsx.mjs';
import { twMerge } from 'file:///Users/belinovich/Desktop/web/labvision/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contacts-D8woWdkr.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-S-zVUa9X.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-dyynnY3J.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CvraMzsW.mjs').then((r) => r["default"] || r.default || r));
...
function createViewportManager(options, state2) {
  const breakpoint = computed({
    get() {
      return state2.value || options.fallbackBreakpoint;
    },
    set(newBreakpoint) {
      state2.value = newBreakpoint;
    }
  });
  ...
  try {
    ...
    if (!deviceType) {
      const { default: Bowser } = await import(
        ...
        'file:///Users/belinovich/Desktop/web/labvision/node_modules/bowser/es5.js'
      );
...
const viewportOptions = { "breakpoints": { "desktop": 1024, "desktopMedium": 1280, "desktopWide": 1600, "mobile": 320, "mobileMedium": 375, "mobileWide": 425, "tablet": 768 }, "cookie": { "expires": 365, "name": "viewport", "path": "/", "sameSite": "Strict", "secure": true }, "defaultBreakpoints": { "desktop": "desktop", "mobile": "mobile", "tablet": "tablet" }, "fallbackBreakpoint": "desktop", "feature": "minWidth" };
const plugin_server_UqHjXsAzTd = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b, _c, _d;
  let __temp, __restore;
  const state2 = useState(STATE_KEY, "$vFUyxW0qJf");
  const manager = createViewportManager(viewportOptions, state2);
  let cookie = "";
  ...
  state2.value = ([__temp, __restore] = executeAsync(() => detectBreakpoint(viewportOptions, { cookie, headers })), __temp = await __temp, __restore(), __temp);
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/belinovich/Desktop/web/labvision/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxStaticRuntime$ctTL1mFRFa = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipxStatic"]: { provider: ipxStaticRuntime$ctTL1mFRFa, defaults: {} }
};
const useImage = () => {
...
const plugin_tLmAP220nC = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      img: useImage()
    }
...
const gsap_qE0fizvEy0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(gsap$2);
  nuxtApp.provide("gsap", gsap$2);
...
const layouts = {
  default: () => import('./default-BeT6bCnP.mjs').then((m) => m.default || m)
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(ToastViewport), mergeProps(delegatedProps.value, {
        class: unref(cn)("fixed top-0 z-[100] items-end flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", props.class)
      }, _attrs), null, _parent));
    };
  }
});
...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[--radix-toast-swipe-end-x] data-[swipe=move]:translate-x-[--radix-toast-swipe-move-x] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        default: "w-fit border bg-background text-foreground rounded-[8px]",
        destructive: "w-fit rounded-[8px] destructive group border-destructive bg-destructive text-destructive-foreground",
        success: "w-fit success group border-background bg-foreground text-background rounded-[8px]"
      }
    },
    defaultVariants: {
      variant: "default"
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<section class="mt-6"${_scopeId}><div class="container"${_scopeId}><p class="text-4xl"${_scopeId}>404</p></div></section>`);
      } else {
        return [
          createVNode("section", { class: "mt-6" }, [
            createVNode("div", { class: "container" }, [
              createVNode("p", { class: "text-4xl" }, "404")
            ])
          ])
        ];
      }
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, navigateTo as c, cn as d, entry$1 as default, useImage as e, prerenderStaticImages as f, useState as g, injectHead as i, nuxtLinkDefaults as n, parseSize as p, resolveUnrefHeadInput as r, toast as t, useNuxtApp as u };
