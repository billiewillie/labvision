import e from"./markdown.BZyvP-q3.js";import r from"./yaml.zytfnWoA.js";import t from"./html-derivative.3Qc0V0lp.js";import"./html.ZVb9jHrO.js";import"./javascript.JMZ6uy5M.js";import"./css.tuEqSfZX.js";const a=Object.freeze({displayName:"MDC",injectionSelector:"L:text.html.markdown",name:"mdc",patterns:[{include:"#component_block"},{include:"#inline"}],repository:{attribute:{patterns:[{captures:{2:{name:"entity.other.attribute-name.html"},3:{patterns:[{include:"#attribute-interior"}]}},match:`(?x)
(
([^=><\\s]*)
(
=["]([^"]*)(["])|[']([^']*)(['])
