...
__export(src_exports, {
  default: () => src_default,
  extract: () => extractor_default,
  fontSize: () => fontSize,
  screens: () => screens
});
module.exports = __toCommonJS(src_exports);
var import_plugin = __toESM(require("tailwindcss/plugin"));
var import_corePlugins = require("tailwindcss-priv/lib/corePlugins");
var import_defaultTheme = __toESM(require("tailwindcss/defaultTheme"));
var import_map_obj2 = __toESM(require("map-obj"));
...
var warn = (code, message) => log(import_picocolors.default.yellow("warn"), code, message);

// src/util/context.ts
var import_map_obj = __toESM(require("map-obj"));
...
function getContext(theme, { checkSC144 = true } = {}) {
  ...
  const filterBreakpoints = (key) => {
    ...
    if (Array.isArray(rawBps) || typeof rawBps !== "object")
      return {};
    return (0, import_map_obj.default)(rawBps, (k, v) => {
      const len = Length.parse(v);
      if (!len)
        return import_map_obj.mapObjectSkip;
      return [k, len];
    });
  };
...
// src/extractor.ts
var regex = __toESM(require("tailwindcss-priv/src/lib/regex"));
...
function getFluidAPI(api, context, { filter } = {}) {
  const addFluid = (orig) => (utilities, options) => {
    ...
    if (filter && !filter(Object.keys(utilities), options))
      return;
    const values = (0, import_filter_obj.includeKeys)(
...
var fluid = import_plugin.default.withOptions((options = {}) => (api) => {
  var _a3, _b;
  if (inFluidPlugin)
    return;
  inFluidPlugin = true;
  ...
  const fontSizeValues = (0, import_map_obj2.default)(
    (_a3 = theme("fontSize")) != null ? _a3 : {},
    (k, v) => {
      const [fontSize2] = Array.isArray(v) ? v : [v];
      return Length.parse(fontSize2) ? [k, v] : import_map_obj2.mapObjectSkip;
    }
  );
  ...
  Object.entries(import_corePlugins.corePlugins).forEach(([name, corePlugin]) => {
...
var _a;
var screens = (0, import_map_obj2.default)((_a = import_defaultTheme.default.screens) != null ? _a : {}, (name, v) => {
  if (typeof v !== "string")
    return [name, v];
  const len = Length.parse(v);
  if (!len || len.unit !== "px")
...
var _a2;
var fontSize = (0, import_map_obj2.default)(
  (_a2 = import_defaultTheme.default.fontSize) != null ? _a2 : {},
